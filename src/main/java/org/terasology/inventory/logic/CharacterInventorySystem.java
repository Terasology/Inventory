...
import org.terasology.inventory.input.binds.DropItemButton;
import org.terasology.inventory.input.binds.ToolbarNextButton;
import org.terasology.inventory.input.binds.ToolbarPrevButton;
import org.terasology.inventory.input.binds.ToolbarSlotButton;
import org.terasology.inventory.logic.events.ChangeSelectedInventorySlotRequest;
...
import org.terasology.inventory.rendering.nui.layers.hud.InventoryHud;
...
public class CharacterInventorySystem extends BaseComponentSystem {
    ...
    public void ensureTransferSlotIsCreated(OnAddedComponent event, EntityRef entityRef,
    ...
    public void onDropItemRequest(DropItemButton event, EntityRef entity) {
        ...
        if (!event.isDown()) {
            ...
            HitResult hitResult = physics.rayTrace(position, direction, 1.5f, StandardCollisionGroup.CHARACTER,
