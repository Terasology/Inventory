...
/**
 * Removed the specified item from the inventory of the entity it was sent to. If the remove was successful, the event
 * will be consumed.
 *
...
public class RemoveItemAction extends AbstractConsumableEvent {
    ...
    private final List<EntityRef> items;
    private final boolean destroyRemoved;
