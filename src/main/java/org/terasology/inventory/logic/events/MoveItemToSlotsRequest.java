...
/**
 * Represents the request to move the item smarly to to one or more of the specified slots. Stacks will be filled up
 * first before an empty slot will be used.
 * <p>
