...
public interface InventoryManager {
     ...
     * @return If the action was successful.
     */
    boolean moveItem(EntityRef fromInventory, EntityRef instigator, int slotFrom, EntityRef toInventory, int slotTo,
                     int count);

    /**
     * Tries to move a item smartly to the specified slots. It will try to fill up existing stacks if possible.
     *
     * @param fromInventory Inventory to move item from.
     * @param instigator Instigator of the action.
     * @param slotFrom Slot to move from.
     ...
     */
    boolean moveItemToSlots(EntityRef instigator, EntityRef fromInventory, int slotFrom, EntityRef toInventory,
